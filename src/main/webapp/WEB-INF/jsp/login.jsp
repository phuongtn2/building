		...
		<form:form class="m-t" role="form" action="/login" name="submitForm" method="post">
			<div class="form-group">
				<input name="userName" type="text" class="form-control"
				       placeholder="<spring:message code="login.username" text="default text" />" required="">
			</div>
			<div class="form-group">
				<input name="password" type="password" class="form-control"
				       placeholder="<spring:message code="login.password" text="default text" />" required="">
			</div>
			<button type="submit" class="btn btn-primary block full-width m-b"><spring:message code="login.login"
			                                                                                   text="default text"/></button>
			<div style="color: red">${error}</div>
			<a href="/forgotpassword">
				<small><spring:message code="login.forgotpassword" text="default text"/></small>
			</a>
		</form:form>
	</div>
</div>
