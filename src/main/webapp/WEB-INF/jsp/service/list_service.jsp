                    ...
                    <c:forEach items="${masterServicesDtoList}" var="masterServices">
                        <tr class="gradeC" >
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <a class="btn-success btn btn-xs" href="/service/edit/${masterServices.serviceCode}"><spring:message code="common.button.edit" text="default text" /></a>
                                    <a class="btn-danger btn btn-xs" href="/service/delete/${masterServices.serviceCode}"><spring:message code="common.button.delete" text="default text" /></a>
                                </div>
                            </td>
                        </tr>
                    </c:forEach>
