				...
				<form:form modelAttribute="complaintDto" method="post" id="userForm">
					...
					<div class="row">
						<div class="form-group">
							<input name="complaintCode" type="hidden" class="form-control"
							       value="<c:if test="${complaintDto.complaintCode!= null}">${complaintDto.complaintCode}</c:if>">
							<div class="col-sm-10">
								...
								<input name="title" type="text"
								       ...
								       value="<c:if test="${complaintDto.title!= null}">${complaintDto.title}</c:if>">
							</div>
							<div class="col-sm-2">
								<label class="control-label"><spring:message code="nav.service"
								                                             text="default text"/></label>
					...
					<div class="form-group">
						<div class="text-center">
							<br>
							<button name="add" class="btn btn-primary" type="submit"><i
									class="fa fa-check"></i><spring:message code="common.button.save"
