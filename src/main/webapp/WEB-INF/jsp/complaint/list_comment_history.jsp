            ...
            <div class="ibox-content">
                ...
                <table class="footable emp-sales table table-stripped table-bordered table-hover dataTables-example" data-page-size="8" data-filter=#filter>
                    ...
                    <tr>
                        ...
                        <th data-hide="phone,tablet"><spring:message code="feedbackhistory.servicecode" text="default text" /></th>
                        <th data-hide="phone,tablet"><spring:message code="feedbackhistory.followstatus" text="default text" /></th>
                    ...
                    <c:forEach items="${listComplaintHistory}" var="complaintDto">
                        <tr class="gradeC" >
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <a class="btn-success btn btn-xs" href="/complaint"><spring:message code="common.button.view" text="default text" /></a>
                                </div>
                            </td>
                        </tr>
                    </c:forEach>
