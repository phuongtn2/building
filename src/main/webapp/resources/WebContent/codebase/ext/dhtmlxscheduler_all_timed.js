...
c=!0);var u=this._safe_copy(s);if(u.end_date=new Date(u.end_date),u.start_date<this._min_date?u.start_date=o(this._min_date,this.config.first_hour):u.start_date=o(r(s.start_date),this.config.first_hour),u.start_date<this._max_date&&u.start_date<u.end_date){if(!c){i[d--]=u;continue}i.splice(d+1,0,u)}}else i.splice(d--,1)}var h="move"==this._drag_mode?!1:n;return a.call(this,i,h)};var i=e.get_visible_events;e.get_visible_events=function(e){return this.config.all_timed&&this.config.multi_day?i.call(this,!1):i.call(this,e);
